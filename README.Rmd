...
params:
  ...
  package: ClarityDictionaryIngester
  font: ROCK
  font_ext: TTF
  color: "#a51417"
---
...
The goal of ``r params$package`` is to provide helpful functions for ingesting the EPIC Clarity Dictionary into a database.
